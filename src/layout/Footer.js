...
export const Footer = () => {
  return (
    <footer className="  shadow dark:bg-gray-900 dark:bg-gradient-to-r dark:from-gray-800 dark:bg-gray-900 dark:to-gray-800">
        <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
            ...
            <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <Link to="/" className="hover:underline">TimeAwayTrek™</Link>. All Rights Reserved.</span>
        </div>
    </footer>
