  ...
  notifications: [
    {
      id: 1,
      user:'John',
      message: 'A supprimer sa demande de congé.',
      modifiedAt: new Date()
    },
    {
      id: 2,
      user:'Jane',
      message: 'A modifier sa demande de congé.',
      modifiedAt: new Date()
    },
    {
        id: 3,
        user:'Ali',
        message: 'A envoyer une demande de congé.',
        modifiedAt: new Date()
    },
    {
        id: 4,
...
export const NotificationAdmin = () => {
    ...
    <div className='flex items-center gap-2 px-4 pb-3'>
      ...
      </div>
      {
        ...
        notifications.map((not)=>(
          <div key={not.id} id="toast-message-cta" className={` w-full  p-4 text-gray-500 ${not.message.includes("accepté")? "bg-green-200 dark:bg-green-500 dark:text-gray-100":"bg-blue-50 dark:bg-blue-300 dark:text-gray-100"}   rounded-lg shadow   m-2`} role="alert">
            <div className="flex">
                <div className="ms-3 text-sm font-normal">
                    <div className='flex justify-start gap-4'>
                      <span className="mb-1 text-sm font-semibold text-gray-900 dark:text-white">{not.user}</span>
  ...
  <div>
    Il n'y a aucune notification pour le moment
  </div>
</div>
