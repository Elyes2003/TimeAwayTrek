      ...
      <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center dark:bg-gray-800">
        ...
        <div className="md:w-1/2 px-8 md:px-16">
          ...
          <form action="" className="flex flex-col gap-4">
            <input className="p-2 mt-8 rounded-xl border" type="text" name="fullname" placeholder="Full Name" />
      ...
      >
        ...
        <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zM4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0z" />
          ...
          <div className="mt-5 text-xs flex justify-between items-center text-[#002D74] dark:text-gray-100">
            ...
            <Link to="/login">
            <button className="py-2 px-5 bg-white border rounded-xl hover:scale-110 duration-300 dark:text-gray-800">Login</button></Link>
          </div>
        </div>
